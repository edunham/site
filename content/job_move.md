+++
path = "2018/08/24/job_move"
title = "Skill Tree Balancing with a Job Move"
date = 2018-08-24
...
![Net chart illustrating skill gaps filled in by emphases of new role](/pictures/skill_tree_chart.png)

If you want to make a similar chart, I made that one with the [net chart type](https://help.libreoffice.org/Chart/Chart_Type_Net) in LibreOffice.
