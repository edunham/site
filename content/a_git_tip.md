+++
path = "2024/05/03/a_git_tip"
title = "Assorted Git & Unix Tips"
date = 2024-05-03
...
-   Commit IDs do not matter to you, but they matter to other people. If you're the only person who has a commit, you can safely take actions (like <span class="title-ref">pull --rebase</span>) which change its ID. But as soon as anybody else has that commit, it is very rude to do anything to that commit which changes its ID.
