+++
path = "2016/01/16/buildbot_and_eoferror"
title = "Buildbot and EOFError"
date = 2016-01-16
...
The fix was to examine `master.cfg` to see [where the HttpStatusPush was created](https://github.com/servo/saltfs/blob/master/buildbot/master/master.cfg#L413), of the form:
...
The real moral of the story is "remember to use [logrotate](http://www.linuxcommand.org/man_pages/logrotate8.html).
