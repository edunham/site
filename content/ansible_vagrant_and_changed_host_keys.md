+++
path = "2016/03/08/ansible_vagrant_and_changed_host_keys"
title = "Ansible, Vagrant, and changed host keys"
date = 2016-03-08
...
author = "E. Dunham"
+++
Related to [this bug](https://github.com/ansible/ansible/issues/9442), the [Vagrant Ansible provisioner](https://www.vagrantup.com/docs/provisioning/ansible.html) seems to ignore some system settings.
