+++
path = "2015/01/21/searching_foss_project_history"
title = "Searching a FOSS project's history"
date = 2015-01-21
...
Find the project's documentation on how to get involved and where to ask questions. On the front page of the [Heka docs](https://hekad.readthedocs.org/en/v0.8.2/index.html), it suggests a mailing list, issue tracker, github project, and IRC channel.

# Searching the Mailing List Archives

Heka's [mailing list archives](https://mail.mozilla.org/pipermail/heka/) don't explicitly offer a search feature. Fortunately, the archives are not overwhelmingly large, so I can just download them and search them locally.
...
Since the GitHub link was given in the [heka docs](https://hekad.readthedocs.org/en/v0.8.2/index.html), it's trivial to clone a copy and search for keywords throughout the source and comments:
...
Luckily, the terms I'm searching for are simple case-insensitive strings, so I can use the search box on the project's [GitHub issue tracker](https://github.com/mozilla-services/heka/issues).

If I needed to search with a regular expression, or simply wanted a local copy of the issue database, my options would be to use a pre-made [GitHub backup tool](https://github.com/joeyh/github-backup) or the [API](https://developer.github.com/v3/issues/).
