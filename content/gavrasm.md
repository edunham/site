+++
path = "2015/02/11/gavrasm"
title = "Installing gavrasm on Arch"
date = 2015-02-11
...
In order to sanity check whether the problem is in my code or the compiler, I installed `gavrasm`, the assembler which the [ECE375 lab website](http://web.engr.oregonstate.edu/~johnstay/ece375/) recommends for Mac users.
...
Download and unzip the [source](http://www.avr-asm-tutorial.net/gavrasm/v34/gavrasm_sources_lin_34.zip). Files will end up in a directory with a name like `Sourcefiles_v3_4`, rather than a sensible name like `gavrasm`, by default.
