+++
path = "2015/02/16/automating_irssi"
title = "Automating Irssi"
date = 2015-02-16
...
I've configured Irssi to automatically join the networks that I want, authenticate me to services, then join my preferred channels. The [Irssi beginner docs](http://irssi.org/beginner/) are a great reference for client commands to set these functions up, but if I was doing it over again, it would save a lot of keystrokes to simply hand-write the config file which those commands end up generating. Here's how you can do that.
...
# .irssi/scripts/autorun/cap\_sasl.pl
...
You can read [Freenode's directions](https://freenode.net/sasl/sasl-irssi.shtml) on setting this up, or just download [cap\_sasl.pl](https://freenode.net/sasl/cap_sasl.pl) and put it into `~/.irssi/scripts/autorun/`.
...
You don't need to touch these to set up autoconnects. To learn more about them, check out [this tutorial](http://linuxreviews.org/software/irc/irssi/#toc4).
...
More information about setting hilights with regexes, coloring, and other cool tricks can be found by grepping for `hilight` in [the manual](http://www.irssi.org/documentation/manual).
...
Section 2 of [the manual](http://www.irssi.org/documentation/manual) has more information on levels.
...
Read about [starting Irssi automatically when your VPS boots](http://edunham.net/2015/02/15/starting_screen_irssi_at_boot.html).
