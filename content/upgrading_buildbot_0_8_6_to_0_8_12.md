+++
path = "2015/10/14/upgrading_buildbot_0_8_6_to_0_8_12"
title = "Upgrading Buildbot 0.8.6 to 0.8.12"
date = 2015-10-14
...
Then for sanity's sake make a virtualenv, and install the following packages. Note that having too new a `sqlalchemy` will [break things](http://stackoverflow.com/questions/17031471/why-buildbot-throw-importerror-cannot-import-name-exceptions).:
