+++
path = "2017/05/23/salt_successful_ping_but_highstate_says_minion_did_not_return"
title = "Salt: Successful ping but highstate says \"minion did not return\""
date = 2017-05-23
...
After installing [all the things](https://github.com/servo/servo/wiki/SaltStack-Administration#osx), I ran a test ping and it looked fine:
...
As explained in [the Salt docs](https://docs.saltstack.com/en/latest/topics/troubleshooting/master.html#commands-time-out-or-do-not-return-output), you can bump the timeout by adding the line `timeout: 30` (or whatever number of seconds you choose) to the file `/etc/salt/master` on the salt master host.
