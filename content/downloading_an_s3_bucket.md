+++
path = "2015/06/17/downloading_an_s3_bucket"
title = "Downloading an S3 bucket"
date = 2015-06-17
...
[Stackoverflow](http://stackoverflow.com/questions/8659382/downloading-an-entire-s3-bucket) pointed me toward the `awscli` Python module. Since I don't keep a system pip, I installed it to a virtualenv:
...
It's surprisingly easy to download the contents of an entire S3 bucket, considering that the documentation on how to do it is spread out over several different sources and buried in [comprehensive reference guides](http://docs.aws.amazon.com/cli/latest/index.html).
