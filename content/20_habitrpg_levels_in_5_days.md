+++
path = "2015/02/02/20_habitrpg_levels_in_5_days"
title = "20 HabitRPG levels in 5 days"
date = 2015-02-02
...
author = "E. Dunham"
+++
I've been having [fun with HabitRPG](http://edunham.net/2015/02/01/habitrpg.html) lately, and discovered this One Neat Trick:

Checklists.


Checklists, at least the way I've been using them, are obscenely overpowered. I'll have a medium-difficulty to-do, break it down into a dozen sub-tasks (because that's what I usually do on to-do lists when I'm procrastinating), get them all checked off, and then reap a level and a half worth of [XP](http://habitrpg.wikia.com/wiki/Experience_Points).
...
![132 damage to boss](/pictures/132dmg.png)

That's a lot of damage to the boss. The calculator I used was [this awesome site](https://oldgods.net/habitrpg/habitrpg_user_data_display.html), in case you haven't discovered it yet.

I'm a rogue, with all my points in INT as per the [guide](http://habitrpg.wikia.com/wiki/Merfy%27s_Rogue_guide) on the subject! I'm not supposed to be able to hit things very hard! Sure, I'm level 25 right now with a [perfect day](http://habitrpg.wikia.com/wiki/The_Perfect_Day) bonus from yesterday, but my stats still aren't too great:

![Stats with STR showing](/pictures/str46.png)
