...
Setting up printers on Arch is easy once you know the right incantations, but can waste some time if you try to do it by skimming the [huge wiki page](https://wiki.archlinux.org/index.php/CUPS) rather than either reading it thoroughly or just following these steps:
...
**Visit the web interface** at [http://localhost:631](http://localhost:631/).
