+++
title = "Rust contributor email stats"
date = 2026-02-20
draft = true
...
author = "E. Dunham"
+++
I'm playing with `git log` in the [rust](https://github.com/rust-lang/rust) repo, and getting some numbers about contributors. Numbers are cool!
...
To see an individual commit, just use `git show` with its hash (the big long hexadecimal number after "commit").
...
Other than the 3 users with completely misconfigured Git settings (and 1 commit each in the project), there are 4 more people with their email set to Git's default. These users have a collective 42 commits in Rust.
...
Oh, they were just obsfuscating their address in case of spam bots or nosey greppers. That's cool.
...
Today I learned that [.no is Norway](https://en.wikipedia.org/wiki/.no).
