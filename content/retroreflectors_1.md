...
![Retroreflector physics diagram](/pictures/retroreflector-physics-diagram.png)
...
![Blast media storage with mylar seal](/pictures/blast-media-storage-hack.png)
...
![Test samples under ambient light](/pictures/samples-ambient-light.png)
...
![Flash photo from distance](/pictures/samples-flash-distant.png)

Here's how it looks from the same distance, still a dark room, but I zoomed in more:

![Zoomed flash photo](/pictures/samples-flash-zoomed.png)

And here's how it looks, still zoomed in, but with the commercial reflector removed:

![Zoomed flash without control reflector](/pictures/samples-flash-no-control.png)
